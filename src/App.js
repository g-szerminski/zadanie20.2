...
import { Router, Route, IndexLink, IndexRoute, Link,  hashHistory } from 'react-router';
...
const Contact = () => <h1>A tu Contact Cmonent</h1>
const Navigation = props => (
    <div>
      <ul>
        <li><IndexLink to="/" activeStyle={{color: '#48abee'}} onlyActiveOnIndex>Home</IndexLink></li>
